    ...
    <div class="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden select-none">
      ...
      <div class="w-full max-w-md space-y-8">
        ...
        <div class="text-center space-y-3">
          ...
          <h1 class="font-display font-bold text-3xl tracking-tight text-white">Welcome back</h1>
          <p class="text-sm text-slate-400">Sign in to manage your reliable webhooks</p>
        </div>
        ...
        <p class="text-center text-xs text-slate-500">
          ...
          <Link to="/register" class="text-brand-400 hover:text-brand-300 font-medium">
            Register here
          </Link>
        </p>
      </div>
